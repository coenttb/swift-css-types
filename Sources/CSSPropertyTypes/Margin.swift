...
public enum Margin: Property, LengthPercentageConvertible {
  ...
  case topHorizontalBottom(
    CSSPropertyTypes.MarginTop,
    LengthPercentage,
    CSSPropertyTypes.MarginBottom
  )

  /// Four values: top, right, bottom, and left (clockwise)
  case sides(
    CSSPropertyTypes.MarginTop,
    CSSPropertyTypes.MarginRight,
    CSSPropertyTypes.MarginBottom,
    CSSPropertyTypes.MarginLeft
  )
...
extension Margin {
  public static func lengthPercentage(_ value: CSSTypeTypes.LengthPercentage) -> Margin {
    .all(value)
  }
}
