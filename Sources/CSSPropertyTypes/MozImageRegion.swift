...
public enum MozImageRegion: Property {
    ...
    public var description: String {
        ...
        case .rect(let top, let right, let bottom, let left):
            return "rect(\(top.description), \(right.description), \(bottom.description), \(left.description))"
...
extension MozImageRegion {
    ...
    public static func pxRect(top: Double, right: Double, bottom: Double, left: Double) -> MozImageRegion {
