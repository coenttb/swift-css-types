...
public struct Url: Sendable, Hashable {
    ...
    ///   - quotes: Whether to put quotes around the URL (default: true)
    /// - Returns: A data URL
    public static func dataUrl(mimeType: String, base64Data: String, quotes: CSSString.Quotes? = .single) -> Url {
    ...
    public var description: String {
        ...
        if let quoteStyle = quotes {
            ...
            case .double:
                ...
                let escapedForDoubleQuotes = escapedValue.replacingOccurrences(of: "\"", with: "\\\"")
