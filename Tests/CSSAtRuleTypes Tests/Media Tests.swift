...
struct MediaTests {
  ...
  func testNotOperator() {
    ...
    #expect(
      complexMedia.rawValue == "@media not screen and (max-width: 500px)"
    )
  }
  ...
  func testOrOperator() {
    ...
    #expect(
      complexMedia.rawValue == "@media screen and (max-width: 500px), print"
    )
  }
  ...
  func testAmpersandOperator() {
    ...
    #expect(
      complexMedia.rawValue == "@media screen and (min-width: 300px) and (max-width: 800px)"
    )
  }
  ...
  func testCombinedNotAndOperators() {
    ...
    #expect(
      negatedQuery.rawValue == "@media not screen and (max-width: 600px)"
    )
  }
  ...
  func testAndOperatorWithPredefinedQueries() {
    ...
    #expect(
      media.rawValue == "@media only screen and (min-width: 832px) and (prefers-color-scheme: dark)"
    )

    // This would also fail
    let combined = Media.mobile.and(Media.orientation(.portrait))
    #expect(
      combined.rawValue == "@media only screen and (max-width: 831px) and (orientation: portrait)"
    )
  }
