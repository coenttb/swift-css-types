...
struct ColorInterpolationMethodTests {
    ...
    func testPolarColorSpacesWithHue() {
        ...
        #expect(
            ColorInterpolationMethod.polar(.lch, .increasing).description == "in lch increasing hue"
        )
        #expect(
            ColorInterpolationMethod.polar(.oklch, .decreasing).description
    ...
    func testCustomColorProfile() {
        ...
        #expect(
            ColorInterpolationMethod.custom(customProfile).description == "in 'my-custom-profile'"
        )
    }
    ...
    func testHashable() {
        ...
        #expect(
            ColorInterpolationMethod.custom(profile1) == ColorInterpolationMethod.custom(profile1)
        )
        #expect(
            ColorInterpolationMethod.custom(profile1) != ColorInterpolationMethod.custom(profile2)
        )
    }
}
