...
struct ColorInterpolationMethodTests {
  ...
  func testPolarColorSpacesWithHue() {
    ...
    #expect(
      ColorInterpolationMethod.polar(.oklch, .decreasing).description == "in oklch decreasing hue"
    )
  }
  ...
  func testHashable() {
    ...
    #expect(
      ColorInterpolationMethod.rectangular(.srgb) == ColorInterpolationMethod.rectangular(.srgb)
    )
    ...
    #expect(
      ColorInterpolationMethod.rectangular(.srgb) != ColorInterpolationMethod.rectangular(.lab)
    )
