...
struct DisplayListitemTests {
    ...
    func testRawValueInitialization() {
        ...
        #expect(
            DisplayListitem(rawValue: "block flow-root list-item")
                == DisplayListitem.blockFlowRootListItem
        )
        #expect(
            DisplayListitem(rawValue: "inline flow list-item") == DisplayListitem.inlineFlowListItem
        )
        #expect(
