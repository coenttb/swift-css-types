...
struct CSSStringTests {
    ...
    func testComplexEscaping() {
        ...
        let complexString = CSSString(
            "This is a \"quoted\" string with 'apostrophes', a \\backslash\\ and\na newline",
            quotes: .double
        )
        #expect(
            complexString.description
                == "\"This is a \\\"quoted\\\" string with 'apostrophes', a \\\\backslash\\\\ and\\A a newline\""
        )

        // Same string but with single quotes
        let complexStringSingleQuotes = CSSString(
            "This is a \"quoted\" string with 'apostrophes', a \\backslash\\ and\na newline",
            quotes: .single
        )
        #expect(
            complexStringSingleQuotes.description
                == "'This is a \"quoted\" string with \\'apostrophes\\', a \\\\backslash\\\\ and\\A a newline'"
        )
    }
