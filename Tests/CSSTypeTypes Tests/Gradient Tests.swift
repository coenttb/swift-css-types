...
struct GradientTests {
  ...
  func testRadialGradientWithCompleteOptions() {
    ...
    #expect(
      gradient.description == "radial-gradient(circle closest-corner at center, yellow, green)"
    )
    ...
    #expect(
      explicitSizeGradient.description == "radial-gradient(ellipse 50% 25% at top left, red, blue)"
    )
  }
  ...
  func testConicGradient() {
    ...
    #expect(
      gradientWithOptions.description == "conic-gradient(from 45deg, at center, red, yellow, blue)"
    )
  }
  ...
  func testRepeatingConicGradient() {
    ...
    #expect(
      gradient.description == "repeating-conic-gradient(from 0deg, at center, red 0%, blue 25%)"
    )
  }
  ...
  func testGradientFactoryMethods() {
    ...
    #expect(
      conicWithOptions.description == "conic-gradient(from 45deg, at center, red, yellow, blue)"
    )
  }
